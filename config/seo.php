...
return [
    ...
    'description' => [
         ...
         */
        'fallback' => "Браузерне розширення для автоматичного приховування небажаних сцен під час трансляції фільмів на Twitch.",
    ],
